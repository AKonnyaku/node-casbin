...
def main():
    ...
    # Reduced padding: 30 instead of 50
    # Header
    print(f"{'':<30}│ {'base':<19} │           {'pr':<19}           │")
    print(f"{'':<30}│       sec/op        │    sec/op      vs base                │   Diff")
    ...
    for name in all_names:
        ...
        print(f"{name:<30}{base_str:<22}{pr_str:<22}{comp_str}")
    ...
    if base_values and pr_values:
        ...
        print(f"{'geomean':<30}{format_val(g_base):<22}{format_val(g_pr):<22}")
