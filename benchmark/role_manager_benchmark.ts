...
export async function addRoleManagerBenchmarks(suite: benchmark.Suite) {
    ...
    const ePattern = await newEnforcer(resolve('examples/performance/rbac_with_pattern_large_scale_model.conf'), resolve('examples/performance/rbac_with_pattern_large_scale_policy.csv'));
    ...
    const eDomainPattern = await newEnforcer(resolve('examples/performance/rbac_with_pattern_large_scale_model.conf'), resolve('examples/performance/rbac_with_pattern_large_scale_policy.csv'));
    ...
    const eBoth = await newEnforcer(resolve('examples/performance/rbac_with_pattern_large_scale_model.conf'), resolve('examples/performance/rbac_with_pattern_large_scale_policy.csv'));
    ...
    const eHasPattern = await newEnforcer(resolve('examples/performance/rbac_with_pattern_large_scale_model.conf'), resolve('examples/performance/rbac_with_pattern_large_scale_policy.csv'));
    ...
    const eHasDomainPattern = await newEnforcer(resolve('examples/performance/rbac_with_pattern_large_scale_model.conf'), resolve('examples/performance/rbac_with_pattern_large_scale_policy.csv'));
    ...
    const eHasBoth = await newEnforcer(resolve('examples/performance/rbac_with_pattern_large_scale_model.conf'), resolve('examples/performance/rbac_with_pattern_large_scale_policy.csv'));
